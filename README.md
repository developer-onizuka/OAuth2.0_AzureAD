...
This is a one of the examples widh AzureAD's OAuth2.0 function instead of using Auth0.
See also https://github.com/developer-onizuka/istioAuth0.<br>
Consider my URL (https://onprem.example.com) which I am using in this repository is a one of APIs which serves subscribers the json as a subscription.
